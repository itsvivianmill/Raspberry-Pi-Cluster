...
We logged in and added our cluster using the "Add Cluster" button and clicking on "Other Cluster". The cluster name we used was mattel and created it. We then used the following command:
<br>
