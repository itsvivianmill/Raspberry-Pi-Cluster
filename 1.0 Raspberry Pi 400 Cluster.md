...
We are going to be following the [NetworkChuck Raspberry Pi](https://www.youtube.com/watch?v=X9fSMGkjtug) video and start by setting up the Raspberry Pi by putting Raspberry Pi Lite 32-bit OS onto it (later changed to 64-bit).
