...
**ACLS:**
- outside-in
  - `permit icmp any 172.30.212.0 255.255.255.0 echo-reply`
  - `permit tcp any 172.30.212..0 255.255.255.0 any echo`
  - `permit icmp any 10.0.0.0 255.0.0.0 echo-reply`
  - `permit tcp any 172.30.212.0 255.255.255.0 eq www`
- dmz-in
  - `permit icmp 172.30.212.0 255.255.255.0 10.0.0.0 255.0.0.0 echo-reply`
  - `deny icmp 172.30.212.0 255.255.255.0 10.0.0.0 255.0.0.0 echo`
  - `permit icmp 172.30.212.0 255.255.255.0 any echo`
